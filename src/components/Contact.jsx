              ...
              <div className="space-y-3 pt-2">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400">linkedin.com/in/ankeshsingh</p>
                  </div>
                </a>
              </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-2.5 rounded-lg text-sm bg-slate-50 dark:bg-slate-800/80 border text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors ${
